...
El **Tutor de Inglés** también necesita una clave privada de OpenAI en Convex:

```bash
npx convex env set OPENAI_API_KEY sk-...
```

No uses el prefijo `EXPO_PUBLIC_` para esta clave ni la configures en Netlify,
ya que solamente debe estar disponible para la acción del backend.
