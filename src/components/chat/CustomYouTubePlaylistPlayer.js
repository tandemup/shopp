...
const styles = StyleSheet.create({
  ...
  summary: { minHeight: 90, flexDirection: "row", alignItems: "stretch", overflow: "hidden" },
  cover: { width: 160, minHeight: 90, alignSelf: "stretch", backgroundColor: "#111827" },
  coverFallback: { width: 160, minHeight: 90, alignSelf: "stretch", alignItems: "center", justifyContent: "center", backgroundColor: "#dc2626" },
  ...
  count: { marginTop: 4, fontSize: 10, lineHeight: 14, fontWeight: "700", color: "#dc2626", flexShrink: 1 },
